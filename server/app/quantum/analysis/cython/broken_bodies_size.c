/* Generated by Cython 0.18 on Mon Apr  1 19:05:12 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__broken_bodies_size
#define __PYX_HAVE_API__broken_bodies_size
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
struct __pyx_opt_args_18broken_bodies_size_get;

/* "broken_bodies_size.pyx":15
 *     return a != a
 * 
...
/* Module declarations from 'broken_bodies_size' */
...
static CYTHON_INLINE char __pyx_f_18broken_bodies_size_is_nan(double); /*proto*/
static PyArrayObject *__pyx_f_18broken_bodies_size_get(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_18broken_bodies_size_get *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "broken_bodies_size"
int __pyx_module_is_main_broken_bodies_size = 0;

/* Implementation of 'broken_bodies_size' */
...
static PyObject *__pyx_pf_18broken_bodies_size_get(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_df, PyObject *__pyx_v_lookback); /* proto */
...
static CYTHON_INLINE char __pyx_f_18broken_bodies_size_is_nan(double __pyx_v_a) {
  char __pyx_r;

  /* "broken_bodies_size.pyx":13
 * 
 * cdef inline char is_nan(double a) nogil:
 *     return a != a             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_18broken_bodies_size_1get(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_18broken_bodies_size_get(PyObject *__pyx_v_df, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_18broken_bodies_size_get *__pyx_optional_args) {
 ...
 *         Py_ssize_t x, y
 */
  __pyx_t_1 = PyObject_GetItem(__pyx_v_df, ((PyObject *)__pyx_n_u__body_size)); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__empty); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *             r[x] = 0
 */
  __pyx_t_10 = __Pyx_PyInt_AsLong(__pyx_v_lookback); if (unlikely((__pyx_t_10 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v_x = __pyx_t_11;

    /* "broken_bodies_size.pyx":26
 * 
 *     for x in range(lookback):
 *         if is_nan(bs[x]):             # <<<<<<<<<<<<<<
 *             r[x] = 0
 ...
 */
    ...
    __pyx_t_13 = __pyx_f_18broken_bodies_size_is_nan((*((double *) ( /* dim=0 */ (__pyx_v_bs.data + __pyx_t_12 * __pyx_v_bs.strides[0]) ))));
    if (__pyx_t_13) {

      /* "broken_bodies_size.pyx":27
 *     for x in range(lookback):
 *         if is_nan(bs[x]):
 *             r[x] = 0             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(long *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_r.diminfo[0].strides) = 0;

      /* "broken_bodies_size.pyx":28
 *         if is_nan(bs[x]):
 *             r[x] = 0
 *             continue             # <<<<<<<<<<<<<<
 *         for y in range(x + 1, lookback):
 ...
 *                 continue
 */
    __pyx_t_15 = __Pyx_PyInt_AsLong(__pyx_v_lookback); if (unlikely((__pyx_t_15 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    for (__pyx_t_16 = (__pyx_v_x + 1); __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      __pyx_v_y = __pyx_t_16;

      /* "broken_bodies_size.pyx":30
 *             continue
 *         for y in range(x + 1, lookback):
 *             if is_nan(bs[y]):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      __pyx_t_13 = __pyx_f_18broken_bodies_size_is_nan((*((double *) ( /* dim=0 */ (__pyx_v_bs.data + __pyx_t_17 * __pyx_v_bs.strides[0]) ))));
      if (__pyx_t_13) {

        /* "broken_bodies_size.pyx":31
 *         for y in range(x + 1, lookback):
 *             if is_nan(bs[y]):
 *                 continue             # <<<<<<<<<<<<<<
 *             if bs[x] > bs[y]:
 ...
 */
      ...
      __pyx_t_9 = ((*((double *) ( /* dim=0 */ (__pyx_v_bs.data + __pyx_t_18 * __pyx_v_bs.strides[0]) ))) > (*((double *) ( /* dim=0 */ (__pyx_v_bs.data + __pyx_t_19 * __pyx_v_bs.strides[0]) ))));
      if (__pyx_t_9) {

        /* "broken_bodies_size.pyx":33
 *                 continue
 *             if bs[x] > bs[y]:
 *                 continue             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(long *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_r.diminfo[0].strides) = ((__pyx_v_y - __pyx_v_x) - 1);

        /* "broken_bodies_size.pyx":36
 *             else:
 *                 r[x] = y - x - 1
 *                 break             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(long *, __pyx_pybuffernd_r.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_r.diminfo[0].strides) = __pyx_v_x;
    }
    __pyx_L8_break:;
    __pyx_L4_continue:;
  }

  /* "broken_bodies_size.pyx":40
 *             r[x] = x
 * 
 *     return r             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_AddTraceback("broken_bodies_size.get", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_r.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_18broken_bodies_size_1get(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_18broken_bodies_size_get[] = "get(df, lookback=None) -> ndarray\nQuantity array of broken body sizes";
static PyObject *__pyx_pw_18broken_bodies_size_1get(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
 ...
 */
  ...
  __pyx_r = __pyx_pf_18broken_bodies_size_get(__pyx_self, __pyx_v_df, __pyx_v_lookback);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

static PyObject *__pyx_pf_18broken_bodies_size_get(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_df, PyObject *__pyx_v_lookback) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_18broken_bodies_size_get __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get", 0);
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_18broken_bodies_size_get(__pyx_v_df, 0, &__pyx_t_2)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  __Pyx_NAMESTR("broken_bodies_size.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("broken_bodies_size.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("broken_bodies_size.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("broken_bodies_size._memoryviewslice"), /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("get"), (PyCFunction)__pyx_pw_18broken_bodies_size_1get, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_18broken_bodies_size_get)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("broken_bodies_size"),
    0, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initbroken_bodies_size(void); /*proto*/
PyMODINIT_FUNC initbroken_bodies_size(void)
#else
PyMODINIT_FUNC PyInit_broken_bodies_size(void); /*proto*/
PyMODINIT_FUNC PyInit_broken_bodies_size(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_broken_bodies_size(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("broken_bodies_size"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "broken_bodies_size")) {
      if (unlikely(PyDict_SetItemString(modules, "broken_bodies_size", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  if (__pyx_module_is_main_broken_bodies_size) {
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_u__lookback), Py_None) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s___DEFAULT, ((PyObject *)__pyx_t_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;

  /* "broken_bodies_size.pyx":1
 * #-*- coding: utf-8-*-             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init broken_bodies_size", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init broken_bodies_size");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
